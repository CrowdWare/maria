...
class ClientEditor(QWidget):
    def __init__(self, win):
        ...
        self.layout.addWidget(self.mobil, 8, 0)
        ...
        self.mobil.textEdited.connect(self.clientChanged)
    ...
    def reload(self):
        if self.win.client:
            ...
            self.mobil.setText(self.win.client["mobil"])
            ...
            self.birthday.setDate(self.win.client["birthdate"])
    ...
    def clientChanged(self):
        ...
        self.win.client["mobil"] = self.mobil.text()
        ...
        print(self.win.client)
        self.win.clients.update_one({'_id': self.win.client['_id']},{'$set': self.win.client}, upsert=False)
